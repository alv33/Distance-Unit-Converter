        ...
        Row {
            ...
            Box {
                ...
                DropdownMenu(expanded = iExpendent, onDismissRequest = { iExpendent =false }) {
                    ...
                    DropdownMenuItem(text = { Text("Micrometers")},
                        onClick = {
                            iExpendent = false
                    ...
                    DropdownMenuItem(text = { Text("Nautical mile")},
                        onClick = {
                            iExpendent = false
                            inputUnit ="Nautical mile"
                            conversionFactor.value = 1852.00
                            convertUnits()
            ...
            Box {
                ...
                DropdownMenu(expanded = oExtendent, onDismissRequest = { oExtendent = false }) {
                    ...
                    DropdownMenuItem(text = { Text("Nanometers")},
                        onClick = {
                            oExtendent = false
                    ...
                    DropdownMenuItem(text = { Text("Nautical mile")},
                        onClick = {
                            ...
                            oConversionFactor.value = 1852.00
                            convertUnits()
                        })
